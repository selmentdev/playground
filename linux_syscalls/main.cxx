...
ssize_t
std_write(int fd, void const* buffer, size_t size)
{
    ssize_t result;
...
__attribute__((__noinline__)) void* derived::operator new(size_t)
{
    std_write(1, "operator new\n", 13);
    return buffer;
}
__attribute__((__noinline__)) void derived::operator delete(void*)
{
    std_write(1, "operator delete\n", 16);
}
#endif

__attribute__((__noinline__)) void derived::action()
{
    std_write(1, "action\n", 7);
}
